...
/* 10:6     shamt           */
/* 5:0      funct           */
void print_r (char *inst, int rd, int rt, int rs) {
    printf ("\nPC:%.8x\tINSTR:%.8x\t %4s R%-2d, R%-2d, R%-2d\n", 
            CURRENT_STATE.PC,
            instr_opcode,
            inst,
            rd,
