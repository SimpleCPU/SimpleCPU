...
void execute_r (uint32_t rs, uint32_t rt, uint32_t rd, unsigned int shamt, unsigned int funct) {
    ...
    switch (funct) {
        ...
        case (0x18): //MULT
            ...
            NEXT_STATE.PC = CURRENT_STATE.PC + 4;
            printf ("PC:%.8x\tINSTR:%.8x\t MULT HI:%-2d, LO:%-2d, R%-2d\n, R%-2d\n", 
                CURRENT_STATE.PC,
                instr_opcode,
                NEXT_STATE.HI,
                NEXT_STATE.LO,
        ...
        case (0x19): //MULTU
            ...
            NEXT_STATE.PC = CURRENT_STATE.PC + 4;
            printf ("PC:%.8x\tINSTR:%.8x\t MULTU HI:%-2d, LO:%-2d, R%-2d\n, R%-2d\n", 
                CURRENT_STATE.PC,
                instr_opcode,
                NEXT_STATE.HI,
                NEXT_STATE.LO,
        ...
        case (0x1a): //DIV
            ...
            NEXT_STATE.PC = CURRENT_STATE.PC + 4;
            printf ("PC:%.8x\tINSTR:%.8x\t DIV HI:%-2d, LO:%-2d, R%-2d\n, R%-2d\n", 
                CURRENT_STATE.PC,
                instr_opcode,
                NEXT_STATE.HI,
                NEXT_STATE.LO,
        ...
        case (0x1b): //DIVU
            ...
            NEXT_STATE.PC = CURRENT_STATE.PC + 4;
            printf ("PC:%.8x\tINSTR:%.8x\t DIVU HI:%-2d, LO:%-2d, R%-2d\n, R%-2d\n", 
                CURRENT_STATE.PC,
                instr_opcode,
                NEXT_STATE.HI,
                NEXT_STATE.LO,
